#
#  Be sure to run `pod spec lint CXLogKit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source_files  = "CXLogKit/*.{h,m,mm}", "CXLogKit/**/*.{h,m,mm}"
  ...
  # spec.library   = "iconv"
   spec.libraries = "z", "resolv.9","c++"
   
   spec.vendored_framework = "mars.framework"
